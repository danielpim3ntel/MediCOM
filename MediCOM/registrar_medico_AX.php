<?php
    ...
    $sql = "INSERT INTO medico VALUES(NULL,'$correo','$nombre','$telefono','$edad','$sexo','$direccion','$escondida')";
    $sqlCheckCorreo = "SELECT * FROM medico WHERE correo = '$correo'";
    ...
    if(mysqli_num_rows($resultadoCheckCorreo) == 1){
        ...
        if(mysqli_affected_rows($conexion) == 1){
            ...
            $respAX_JSON["msj"] = "<h3> El registro se realizo correctamente </h3>";
        }else{
            $respAX_JSON["codigo"] = 2;

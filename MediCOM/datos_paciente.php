                ...
                <div id="test-swipe-1" class="col s12 white">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l6 input-field">
                            ...
                            <input type="text" id="nombre" name="nombre" value="<?php echo $infUsuario[2] ?>" readonly="readonly">
                        </div>

                        <div class="col s12 m6 l6 input-field">
                            <i class="fas fa-solid fa-venus-mars prefix"></i>
                            <label for="sexo">Sexo:</label>
                            <input type="text" id="sexo" name="sexo" value="<?php echo $infUsuario[5] ?>" readonly="readonly">
                        </div>

                        <div class="col s12 m6 l6 input-field">
                            <i class="fas fa-mobile-alt prefix"></i>
                            <label for="telefono">Telefono:</label>
                            <input type="text" id="telefono" name="telefono" value="<?php echo $infUsuario[3] ?>" readonly="readonly">
                        </div>

                        <div class="col s12 m6 l6 input-field">
                            <i class="fas fa-solid fa-calendar-day prefix"></i>
                            <label for="edad">Edad:</label>
                            <input type="number" id="edad" name="edad" value="<?php echo $infUsuario[4] ?>" readonly="readonly">
                        </div>

                        <div class="col s12 m6 l6 input-field">
                            <i class="fas fa-envelope prefix"></i>
                            <label for="correo">Correo:</label>
                            <input type="text" id="correo" name="correo" value="<?php echo $infUsuario[1] ?>" readonly="readonly">
                        </div>

                        <div class="col s12 m6 l6 input-field">
                            <i class="fas fa-solid fa-weight-hanging prefix"></i>
                            <label for="peso">Peso:</label>
                            <input type="number" id="peso" name="peso" value="<?php echo $infUsuario[6] ?>" readonly="readonly">
                        </div>

                        <div class="col s12 m12 l12 input-field">
                            <i class="fas fa-solid fa-house-user prefix"></i>
                            <label for="direccion">Dirección:</label>
                            <input type="text" id="direccion" name="direccion" value="<?php echo $infUsuario[7] ?>" readonly="readonly">
                        </div>
                    ...
                    <form id="formActualizarDatos">
                        <div class="row">
                            <div class="col s12 m6 l6 input-field">
                                ...
                                <input type="text" id="telefonoNew" name="telefonoNew" value="<?php echo $infUsuario[3] ?>" data-validetta="required" >
                            </div>
                            <div class="col s12 m6 l6 input-field">
                                <i class="fas fa-solid fa-weight-hanging prefix"></i>
                                <label for="pesoNew">Peso:</label>
                                <input type="number" id="pesoNew" name="pesoNew" value="<?php echo $infUsuario[6] ?>" data-validetta="required">
                            </div>
                            <div class="col s12 m12 l12 input-field">
                                <i class="fas fa-solid fa-house-user prefix"></i>
                                <label for="direccionNew">Dirección:</label>
                                <input type="text" id="direccionNew" name="direccionNew" value="<?php echo $infUsuario[7] ?>" data-validetta="required">
                            </div>
                            <div class="col s12 m6 l6 input-field">
                                <i class="fas fa-key prefix"></i>

<?php
    ...
    $sql = "INSERT INTO resform values (null,'$correo','Esquizoide','$porcentaje','$categoria')";
    $sql1 = "SELECT * FROM resform WHERE correo='$correo' and transtorno='Esquizoide'";
    $resultado = mysqli_query($conexion,$sql1);
    $info = mysqli_num_rows($resultado);
    if($info==1){
        $sql2="DELETE FROM resform WHERE correo='$correo' and transtorno='Esquizoide'";

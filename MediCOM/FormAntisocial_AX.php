<?php
    $correo = $_POST["correo"];
    $respuesta = $_POST["p1"]+$_POST["p2"]+$_POST["p3"]+$_POST["p4"]+$_POST["p5"]+$_POST["p6"]+$_POST["p7"]+$_POST["p8"]+$_POST["p9"]+$_POST["p10"]+$_POST["p11"]+$_POST["p12"];
    $porcentaje=$respuesta/72*100;
    if($porcentaje<36)
    ...
    $sql = "INSERT INTO resform values (null,'$correo','Antisocial','$porcentaje','$categoria')";
    $sql1 = "SELECT * FROM resform WHERE correo='$correo' and transtorno='Antisocial'";
    $resultado = mysqli_query($conexion,$sql1);
    $info = mysqli_num_rows($resultado);
    if($info==1){
        $sql2="DELETE FROM resform WHERE correo='$correo' and transtorno='Antisocial'";
